				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							<input class="span6" type="text" name="ngrok" id="ngrok" onchange="modify(this.value)" placeholder="enter ngrok key..." value="<?=$user['key']?>">
						</div>
						<span class="text-info">Get from <a href="//dashboard.ngrok.com/">ngrok dashboard</a></span>
					</div>
				</div>
					</div>
					<div class="well">
					...
					<footer class="muted">&copy; <?php echo date('Y'); ?> MPanel - acayrin</footer>
				</div>
				<div class="span7">
					<pre id="log" class="well well-small"></pre>
					<form id="frm-cmd">
						<input type="text" id="cmd" name="cmd" maxlength="250" placeholder="Insert command..." autofocus>
					</form>
				</div>
			</div>
		<?php
			...
			echo '
			<p class="alert alert-info">Your account doesn;t</p>
			<footer class="muted">&copy; ' . date('Y') . ' MPanel - acayrin</footer>
';
		?>
	</div>
</div>
